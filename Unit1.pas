...
begin
  ...
  DataModule2.zqry1.SQL.Add('insert into kustomer (nik, nama, telp, email, alamat, member) values (:nik, :nama, :telp, :email, :alamat, :member)');
  DataModule2.zqry1.Params.ParamByName('nik').AsInteger := StrToInt(edt1.Text);
  DataModule2.zqry1.Params.ParamByName('nama').AsString := edt2.Text;
  ...
  DataModule2.zqry1.Params.ParamByName('member').AsString := edt6.Text;
...
begin
  ...
  DataModule2.zqry1.SQL.Clear;
  DataModule2.zqry1.SQL.Add('select * from kustomer where nik like :searchTerm or nama like :searchTerm or telp like :searchTerm or email like :searchTerm or alamat like :searchTerm or member like :searchTerm');
...
begin
  ...
  try
    Report.LoadFromFile('D:\tugas\UAS VISUAL 2\laporan.fr3');
